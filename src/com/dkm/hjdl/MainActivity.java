...
public class MainActivity extends com.unity3d.player.UnityPlayerActivity {
	...
	void showTip4Exit() {
		AlertDialog.Builder alertDialog = new AlertDialog.Builder(this).setTitle("退出游戏").setMessage("您确定要退出游戏么?").setPositiveButton("确定", new DialogInterface.OnClickListener() {
			@Override
